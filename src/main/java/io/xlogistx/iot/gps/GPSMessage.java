...
public abstract class GPSMessage extends DataDAO
{
	...
	public static final NVConfigEntity NVC_GPS_MESSAGE = new NVConfigEntityLocal("gps_message", null , "GPSMessage", true, false, false, false,GPSMessage.class, SharedUtil.toNVConfigList(NVC_MESSAGE_ID, NVC_MESSAGE_TYPE), null, false, GPSMessage.NVC_DATA_DAO);//,SharedUtil.extractNVConfigs( new Params[]{Params.REFERENCE_ID, Params.NAME, Params.LENGTH}));
