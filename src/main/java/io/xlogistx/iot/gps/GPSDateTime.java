...
public class GPSDateTime extends GPSMessage
{
	...
	private static final NVConfigEntity  NVC_GPS_DATE_TIME = new NVConfigEntityLocal("gps_date_time", null , "GPSDateTime", true, false, false, false,
		GPSDateTime.class, SharedUtil.toNVConfigList(NVC_GPS_TIME, NVC_TIME_ZONE), null, false, GPSMessage.NVC_GPS_MESSAGE);
