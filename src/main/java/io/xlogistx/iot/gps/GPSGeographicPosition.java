...
public class GPSGeographicPosition extends GPSMessage
{
	...
	private static final NVConfigEntity  NVC_GPS_GEOGRAPHIC_POSITION = new NVConfigEntityLocal("gps_geogrpahic_position", null , "GPSGeographicPosition", true, false, false, false,
			GPSGeographicPosition.class, SharedUtil.extractNVConfigs(Params.values()), SharedUtil.toNVConfigList(GPSMessage.NVC_MESSAGE_ID, 
