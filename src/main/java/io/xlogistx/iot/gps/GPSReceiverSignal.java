...
public class GPSReceiverSignal extends GPSMessage
{
	...
	private static final NVConfigEntity  NVC_GPS_RECEIVER_SIGNAL = new NVConfigEntityLocal("gps_receiver_signal", null , "GPSReceiverSignal", true, false, false, false,
			GPSReceiverSignal.class, SharedUtil.extractNVConfigs(Params.values()), SharedUtil.toNVConfigList(GPSMessage.NVC_MESSAGE_ID, 
