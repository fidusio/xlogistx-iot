...
public class DeviceInfoTest {
    ...
    public void createDeviceInfo() throws IOException {
        ...
        System.out.println(json.equals(json1) + " " + SUS.getBytes(json).length);

        System.out.println(SUS.formatStringToByteArray(json1, false));
    ...
    public void readDeviceInfo() throws IOException {
        ...
        String json1 = GSONUtil.toJSON(dev, false, false, false);
        System.out.println(json1);
        System.out.println(json.equals(json1) + " " + SUS.getBytes(json).length + " " + SUS.getBytes(json1).length);
