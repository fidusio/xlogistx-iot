 ...
 */
public class NPWMRangeExec implements Runnable {
    ...
    public NPWMRangeExec(Pwm pwmOutput, Range<Integer> dutyCycleRange, int frequency, long cycleDelay, int repeat) {
