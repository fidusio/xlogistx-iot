...
public class NI2CEndPoints
        extends PropertyContainer<NVGenericMap> {
    private static final LogWrapper log = new LogWrapper(NI2CEndPoints.class).setEnabled(true);
    ...
    public SimpleMessage i2cCommand(@ParamProp(name = "i2c-bus") int bus,
        ...
        return NI2CUtil.SINGLETON.sendI2CCommand(bus, address, command, SharedUtil.toCanonicalID('/', "i2c", bus, Integer.toHexString(address), command).toUpperCase(), 1);
    }
    ...
    public SimpleMessage i2cDataFilterMap(@ParamProp(name = "i2c-bus") int bus,
        ...
        mdf.setUnit(unit);
        IOTDataUtil.DATA_FILTER.registerValue(mdf);
    ...
    public SimpleMessage i2cSupportedCommands() {
        ...
        I2CCodecBase[] allMessages = NI2CUtil.SINGLETON.getI2cCodecs();
        SimpleMessage response = new SimpleMessage();
    ...
    public SimpleMessage i2cScanBus(@ParamProp(name = "i2c-bus") int bus) throws IOException {
        ...
        I2C[] actives = NI2CUtil.SINGLETON.scanI2CDevices(bus, 1, 127);
...
//
//
//        log.getLogger().info("bus: " + bus + " address: " + addressID + " volt-ref: " + pga + " ports: " + Arrays.toString(ports) + " delay:" + device.getDelay());
//        SimpleMessage response = new SimpleMessage();
//
//        if (ports == null)
...
//            log.getLogger().info("bus: " + bus + " address: " + addressID + " volt-ref: " + pga + " port: " + p + " delay:" + device.getDelay() + " volt: " + volt);
//        }
//
...
//
//
//        log.getLogger().info("bus: " + bus + " address: " + addressID + " delay:" + delay);
//        if (delay != null) {
